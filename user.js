/*
 * settings that *actually* break webpages and certain interactions.
 * uncomment and comment certain lines if you need to enable them.
 */
...
user_pref("media.peerconnection.ice.proxy_only_if_behind_prox", true);
